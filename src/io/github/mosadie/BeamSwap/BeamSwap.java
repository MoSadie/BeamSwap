...
import io.github.mosadie.BeamSwap.commands.CommandBeamSwap;
...
public class BeamSwap extends JavaPlugin {
	...
	public void onEnable() {
		...
		getLogger().info("Using Beam: " + config.getBoolean("useBeam"));
		getLogger().info("Beam Username: " + config.getString("beam_username"));
		getLogger().info("Beam Password: (NOT GOING TO PRINT, DUH :) )");
		getLogger().info("Using Two Factor auth for Beam: " + config.getBoolean("beam_twofactorrequired"));
		getLogger().info("Beam Channel ID: " + config.getInt("beam_channelid"));
		
		try {
	        Metrics metrics = new Metrics(this);
	        
	        Graph beamUsed = metrics.createGraph("Servers that use Beam support");
	        
	        if (config.getBoolean("useBeam")) beamUsed.addPlotter(new Metrics.Plotter("Beam Enabled") {
	        ...
	        else if (!config.getBoolean("useBeam")) beamUsed.addPlotter(new Metrics.Plotter("Beam Disabled") {
